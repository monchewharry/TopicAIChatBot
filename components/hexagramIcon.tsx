...
export const HexagramIcon = ({ size = 17 }: { size: number }) => (
    <svg
        width={size}
        height={size}
        viewBox="0 0 512 512"
        id="svg2793"
        className="text-primary-foreground" // ✅ Tailwind class for automatic theming

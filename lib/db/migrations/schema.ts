import { pgTable, uuid, varchar, foreignKey, timestamp, text, jsonb, boolean, json, primaryKey } from "drizzle-orm/pg-core"
...
export const chat = pgTable("Chat", {
	...
	topicId: varchar().default(TopicIds.numerology).notNull(),
	topicInputValues: jsonb(),
},
	(table) => {
		return {
